...
public class PreviewChannelIJKActivity extends AppCompatActivity implements  AdapterView.OnItemClickListener,View.OnClickListener,SimpleGestureListener,AdapterView.OnItemLongClickListener,
   IMediaPlayer.OnCompletionListener,IMediaPlayer.OnErrorListener{
    ...
    private void getRespond(){
        try {
            String string = MyApp.instance.getIptvclient().login(Constants.GetUrl(this)+"="+Constants.GetKey(this));
            try {
                ...
                if (object.getBoolean("status")) {
                    ...
                    String rss_feed = "                 "+object.get("message")+"                 ";
...
//            Toast.makeText(this,""+event.getKeyCode(),Toast.LENGTH_SHORT).show();
            switch (event.getKeyCode()){
                case KeyEvent.KEYCODE_MENU:
                    ...
                    PackageDlg packageDlg = new PackageDlg(PreviewChannelIJKActivity.this, pkg_datas, new PackageDlg.DialogPackageListener() {
                        @Override
